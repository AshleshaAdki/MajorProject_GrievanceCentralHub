					...
					<div class="row">
						<div class="col-md-2">
							<div class="list-group">
								...
								<a href="grpgrievform.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> View Filed Grievances</a>
