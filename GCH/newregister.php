...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into student(fullName,userEmail,password,contactNo,status) values('$fullname','$email','$password','$contactno','$status')");
...
echo htmlentities($msg);
    ...
    <script>
        $.backstretch("assets/img/ani10.gif", {speed: 500});
    </script>
