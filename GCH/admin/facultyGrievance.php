...
<tbody>
<?php
$sql = "SELECT * FROM `facultycomplain`";
...
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<tr data-id="' . $complaintNumber . '">
                <th scope="row">' . $complaintNumber . '</th>
                <td>' . $complain . '</td>
                <td>' . $regDate . '</td>
    ...
    <script>
        $(document).ready(function() {
            $(".update-btn").click(function() {
                ...
                var complaintNumber = row.data("id");
                var newStatus = row.find(".status-select").val();

                $.ajax({
                    type: "POST",
                    url: "updateStatus.php",
                    data: { complaintNumber: complaintNumber, status: newStatus },
                    success: function(response) {
                        // Update the status cell text without refreshing the page
