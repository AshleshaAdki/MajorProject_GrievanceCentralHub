...
$sql="select * from `academy` where student_id='$student_id'";
...
if(isset($_POST['submit'])){
    ...
    $sql="update `academy` set student_id='$student_id',name='$name',email='$email',password='$password' where student_id='$student_id'";  
    $result=mysqli_query($db,$sql);
    if($result){
